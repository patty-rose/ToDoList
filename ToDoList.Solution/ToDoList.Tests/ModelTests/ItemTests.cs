...
using MySql.Data.MySqlClient; // for using with MySql
using System;
...
namespace ToDoList.Tests
{
  ...
  public class ItemTests : IDisposable
  {
    ...
    }//this overrides the DBconfig string we set in Startup.cs to ensure we're connected to the DB_test db and not our development DB.
